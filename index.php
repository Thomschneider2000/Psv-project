...
<html lang="en">
    ...
    <?php include "nav.php"?>
			...
			<div class="container">
				<div class="grid">
					<a class="player" href="../psv-project/POC--grid-betting/index.php">Heatmap</a>
					<a class="player" href="../psv-project/POC--grid-betting/index.php">Grid</a>
					<a class="player" href="bet1v1.php">1v1-bet</a>
					<a class="player" href="timeline.php">Classic</a>
				</div>
